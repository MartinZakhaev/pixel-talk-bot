...
with block:
    gr.Markdown("""
                <footer>
                    <img style="display: block; margin-left: 0px; margin-right: auto;" src="https://cdn.discordapp.com/attachments/1072210515457224754/1135412968079769710/logo_itenas_black.png" alt="ITENAS logo" width="100px" height="50px">
                    <img style="display: block; margin-left: auto; margin-right: 0px;" src="https://cdn.discordapp.com/attachments/1072210515457224754/1134098140853702729/logo_kmmi.png" alt="ITENAS logo" width="100px" height="50px">
                </footer>
    """)
